  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginTop: 24, textAlign: 'center', fontSize: 13, color: 'rgba(10,10,10,0.3)' }}>
          New here?{' '}
          <a href="/join" style={{ color: 'rgba(10,10,10,0.55)', textDecoration: 'none', fontWeight: 500 }}>
            Set up your board
          </a>
        </div>
      </div>
